...
class FlexSwitchShow( object):
    ...
    def printArpEntryState(self, IpAddr, addHeader=True, brief=None):
        ...
        objs = self.swtch.getArpEntryState(
                                           IpAddr)
    ...
    def printPlatformMgmtDeviceState(self, DeviceName, addHeader=True, brief=None):
        ...
        objs = self.swtch.getPlatformMgmtDeviceState(
                                                     DeviceName)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printOspfIPv4RouteState(self, DestId,DestType,AddrMask, addHeader=True, brief=None):
        ...
        objs = self.swtch.getOspfIPv4RouteState(
                                                DestId,
                                                DestType,
                                                AddrMask)
        if objs.status_code in self.httpSuccessCodes:
    ...
    def printNdpEntryHwState(self, IpAddr, addHeader=True, brief=None):
        ...
        objs = self.swtch.getNdpEntryHwState(
                                             IpAddr)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printIPv6RouteState(self, DestinationNw, addHeader=True, brief=None):
        ...
        objs = self.swtch.getIPv6RouteState(
                                            DestinationNw)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printPolicyPrefixSetState(self, Name, addHeader=True, brief=None):
        ...
        objs = self.swtch.getPolicyPrefixSetState(
                                                  Name)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printBGPv4NeighborStates(self, addHeader=True, brief=None):
        ...
        if addHeader:
            ...
            header.append('SessionStateUpdatedTime')
        ...
        for obj in objs:
            ...
            values.append('%s' % o['SessionStateUpdatedTime'])
            rows.append(values)
    ...
    def printBGPv4NeighborState(self, IntfRef,NeighborAddress, addHeader=True, brief=None):
        ...
        objs = self.swtch.getBGPv4NeighborState(
                                                IntfRef,
                                                NeighborAddress)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
    ...
    def printNDPEntryState(self, IpAddr, addHeader=True, brief=None):
        ...
        objs = self.swtch.getNDPEntryState(
                                           IpAddr)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printLaPortChannelState(self, IntfRef, addHeader=True, brief=None):
        ...
        objs = self.swtch.getLaPortChannelState(
                                                IntfRef)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printDistributedRelayState(self, DrniName, addHeader=True, brief=None):
        ...
        objs = self.swtch.getDistributedRelayState(
                                                   DrniName)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printStpPortState(self, IntfRef,Vlan, addHeader=True, brief=None):
        ...
        objs = self.swtch.getStpPortState(
                                          IntfRef,
                                          Vlan)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
    ...
    def printCoppStatState(self, Protocol, addHeader=True, brief=None):
        ...
        objs = self.swtch.getCoppStatState(
                                           Protocol)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printBGPPolicyConditionState(self, Name, addHeader=True, brief=None):
        ...
        objs = self.swtch.getBGPPolicyConditionState(
                                                     Name)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printApiInfoState(self, Url, addHeader=True, brief=None):
        ...
        objs = self.swtch.getApiInfoState(
                                          Url)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printFanSensorState(self, Name, addHeader=True, brief=None):
        ...
        objs = self.swtch.getFanSensorState(
                                            Name)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printConfigLogState(self, SeqNum,API,Time, addHeader=True, brief=None):
        ...
        objs = self.swtch.getConfigLogState(
                                            SeqNum,
                                            API,
                                            Time)
        if objs.status_code in self.httpSuccessCodes:
    ...
    def printBGPPolicyStmtState(self, Name, addHeader=True, brief=None):
        ...
        objs = self.swtch.getBGPPolicyStmtState(
                                                Name)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printDWDMModuleState(self, ModuleId, addHeader=True, brief=None):
        ...
        objs = self.swtch.getDWDMModuleState(
                                             ModuleId)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printDhcpRelayIntfState(self, IfIndex, addHeader=True, brief=None):
        ...
        objs = self.swtch.getDhcpRelayIntfState(
                                                IfIndex)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printLaPortChannelIntfRefListState(self, IntfRef, addHeader=True, brief=None):
        ...
        objs = self.swtch.getLaPortChannelIntfRefListState(
                                                           IntfRef)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printPlatformState(self, ObjName, addHeader=True, brief=None):
        ...
        objs = self.swtch.getPlatformState(
                                           ObjName)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printBfdSessionParamState(self, Name, addHeader=True, brief=None):
        ...
        objs = self.swtch.getBfdSessionParamState(
                                                  Name)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printAsicGlobalState(self, ModuleId, addHeader=True, brief=None):
        ...
        objs = self.swtch.getAsicGlobalState(
                                             ModuleId)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printOspfLsdbEntryState(self, LsdbType,LsdbAreaId,LsdbLsid,LsdbRouterId, addHeader=True, brief=None):
        ...
        objs = self.swtch.getOspfLsdbEntryState(
                                                LsdbType,
                                                LsdbAreaId,
                                                LsdbLsid,
                                                LsdbRouterId)
    ...
    def printArpLinuxEntryState(self, IpAddr, addHeader=True, brief=None):
        ...
        objs = self.swtch.getArpLinuxEntryState(
                                                IpAddr)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printDhcpRelayHostDhcpState(self, MacAddr, addHeader=True, brief=None):
        ...
        objs = self.swtch.getDhcpRelayHostDhcpState(
                                                    MacAddr)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printDhcpRelayIntfServerState(self, IntfId, addHeader=True, brief=None):
        ...
        objs = self.swtch.getDhcpRelayIntfServerState(
                                                      IntfId)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printLLDPIntfState(self, IntfRef, addHeader=True, brief=None):
        ...
        objs = self.swtch.getLLDPIntfState(
                                           IntfRef)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printOspfVirtNbrEntryState(self, VirtNbrRtrId,VirtNbrArea, addHeader=True, brief=None):
        ...
        objs = self.swtch.getOspfVirtNbrEntryState(
                                                   VirtNbrRtrId,
                                                   VirtNbrArea)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
    ...
    def printDWDMModuleClntIntfState(self, ClntIntfId,ModuleId, addHeader=True, brief=None):
        ...
        objs = self.swtch.getDWDMModuleClntIntfState(
                                                     ClntIntfId,
                                                     ModuleId)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
    ...
    def printRouteStatState(self, Vrf, addHeader=True, brief=None):
        ...
        objs = self.swtch.getRouteStatState(
                                            Vrf)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printRouteDistanceState(self, Protocol, addHeader=True, brief=None):
        ...
        objs = self.swtch.getRouteDistanceState(
                                                Protocol)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printBGPv6NeighborState(self, IntfRef,NeighborAddress, addHeader=True, brief=None):
        ...
        objs = self.swtch.getBGPv6NeighborState(
                                                IntfRef,
                                                NeighborAddress)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
    ...
    def printMacTableEntryState(self, MacAddr, addHeader=True, brief=None):
        ...
        objs = self.swtch.getMacTableEntryState(
                                                MacAddr)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printFanSensorPMDataState(self, Class,Name, addHeader=True, brief=None):
        ...
        objs = self.swtch.getFanSensorPMDataState(
                                                  Class,
                                                  Name)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
    ...
    def printOspfNbrEntryState(self, NbrIpAddr,NbrAddressLessIndex, addHeader=True, brief=None):
        ...
        objs = self.swtch.getOspfNbrEntryState(
                                               NbrIpAddr,
                                               NbrAddressLessIndex)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
    ...
    def printQsfpPMDataState(self, Resource,Class,QsfpId, addHeader=True, brief=None):
        ...
        objs = self.swtch.getQsfpPMDataState(
                                             Resource,
                                             Class,
                                             QsfpId)
        if objs.status_code in self.httpSuccessCodes:
    ...
    def printAclRuleState(self, RuleName, addHeader=True, brief=None):
        ...
        objs = self.swtch.getAclRuleState(
                                          RuleName)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printIPv4RouteHwState(self, DestinationNw, addHeader=True, brief=None):
        ...
        objs = self.swtch.getIPv4RouteHwState(
                                              DestinationNw)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printIPv4RouteState(self, DestinationNw, addHeader=True, brief=None):
        ...
        objs = self.swtch.getIPv4RouteState(
                                            DestinationNw)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printPowerConverterSensorState(self, Name, addHeader=True, brief=None):
        ...
        objs = self.swtch.getPowerConverterSensorState(
                                                       Name)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printBfdGlobalState(self, Vrf, addHeader=True, brief=None):
        ...
        objs = self.swtch.getBfdGlobalState(
                                            Vrf)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printBGPGlobalState(self, RouterId, addHeader=True, brief=None):
        ...
        objs = self.swtch.getBGPGlobalState(
                                            RouterId)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printBfdSessionState(self, IpAddr, addHeader=True, brief=None):
        ...
        objs = self.swtch.getBfdSessionState(
                                             IpAddr)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printOspfEventState(self, Index, addHeader=True, brief=None):
        ...
        objs = self.swtch.getOspfEventState(
                                            Index)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printBufferGlobalStatState(self, DeviceId, addHeader=True, brief=None):
        ...
        objs = self.swtch.getBufferGlobalStatState(
                                                   DeviceId)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printIPv6IntfState(self, IntfRef, addHeader=True, brief=None):
        ...
        objs = self.swtch.getIPv6IntfState(
                                           IntfRef)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printPolicyStmtState(self, Name, addHeader=True, brief=None):
        ...
        objs = self.swtch.getPolicyStmtState(
                                             Name)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printPowerConverterSensorPMDataState(self, Class,Name, addHeader=True, brief=None):
        ...
        objs = self.swtch.getPowerConverterSensorPMDataState(
                                                             Class,
                                                             Name)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
    ...
    def printStpBridgeState(self, Vlan, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('Vlan')
            header.append('IfIndex')
        ...
        objs = self.swtch.getStpBridgeState(
                                            Vlan)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printTemperatureSensorState(self, Name, addHeader=True, brief=None):
        ...
        objs = self.swtch.getTemperatureSensorState(
                                                    Name)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printRouteStatsPerInterfaceState(self, Intfref, addHeader=True, brief=None):
        ...
        objs = self.swtch.getRouteStatsPerInterfaceState(
                                                         Intfref)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printNDPGlobalState(self, Vrf, addHeader=True, brief=None):
        ...
        objs = self.swtch.getNDPGlobalState(
                                            Vrf)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printVoltageSensorPMDataState(self, Class,Name, addHeader=True, brief=None):
        ...
        objs = self.swtch.getVoltageSensorPMDataState(
                                                      Class,
                                                      Name)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
    ...
    def printVrrpIntfState(self, VRID,IfIndex, addHeader=True, brief=None):
        ...
        objs = self.swtch.getVrrpIntfState(
                                           VRID,
                                           IfIndex)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
    ...
    def printSystemStatusState(self, Name, addHeader=True, brief=None):
        ...
        objs = self.swtch.getSystemStatusState(
                                               Name)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printIppLinkState(self, IntfRef,DrNameRef, addHeader=True, brief=None):
        ...
        objs = self.swtch.getIppLinkState(
                                          IntfRef,
                                          DrNameRef)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
    ...
    def printBufferPortStatState(self, IntfRef, addHeader=True, brief=None):
        ...
        objs = self.swtch.getBufferPortStatState(
                                                 IntfRef)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printTemperatureSensorPMDataState(self, Class,Name, addHeader=True, brief=None):
        ...
        objs = self.swtch.getTemperatureSensorPMDataState(
                                                          Class,
                                                          Name)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
    ...
    def printOspfAreaEntryState(self, AreaId, addHeader=True, brief=None):
        ...
        objs = self.swtch.getOspfAreaEntryState(
                                                AreaId)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printPolicyConditionState(self, Name, addHeader=True, brief=None):
        ...
        objs = self.swtch.getPolicyConditionState(
                                                  Name)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printXponderGlobalState(self, XponderId, addHeader=True, brief=None):
        ...
        objs = self.swtch.getXponderGlobalState(
                                                XponderId)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printIPv6RouteHwState(self, DestinationNw, addHeader=True, brief=None):
        ...
        objs = self.swtch.getIPv6RouteHwState(
                                              DestinationNw)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printPolicyDefinitionState(self, Name, addHeader=True, brief=None):
        ...
        objs = self.swtch.getPolicyDefinitionState(
                                                   Name)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printIsisGlobalState(self, Vrf, addHeader=True, brief=None):
        ...
        objs = self.swtch.getIsisGlobalState(
                                             Vrf)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printLogicalIntfState(self, Name, addHeader=True, brief=None):
        ...
        objs = self.swtch.getLogicalIntfState(
                                              Name)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printThermalState(self, ThermalId, addHeader=True, brief=None):
        ...
        objs = self.swtch.getThermalState(
                                          ThermalId)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printLinkScopeIpState(self, LinkScopeIp, addHeader=True, brief=None):
        ...
        objs = self.swtch.getLinkScopeIpState(
                                              LinkScopeIp)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printBGPPolicyActionState(self, Name, addHeader=True, brief=None):
        ...
        objs = self.swtch.getBGPPolicyActionState(
                                                  Name)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printBGPPolicyDefinitionState(self, Name, addHeader=True, brief=None):
        ...
        objs = self.swtch.getBGPPolicyDefinitionState(
                                                      Name)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printIPv4IntfState(self, IntfRef, addHeader=True, brief=None):
        ...
        objs = self.swtch.getIPv4IntfState(
                                           IntfRef)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printSystemSwVersionState(self, FlexswitchVersion, addHeader=True, brief=None):
        ...
        objs = self.swtch.getSystemSwVersionState(
                                                  FlexswitchVersion)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printDaemonState(self, Name, addHeader=True, brief=None):
        ...
        objs = self.swtch.getDaemonState(
                                         Name)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printSystemParamState(self, Vrf, addHeader=True, brief=None):
        ...
        objs = self.swtch.getSystemParamState(
                                              Vrf)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printVoltageSensorState(self, Name, addHeader=True, brief=None):
        ...
        objs = self.swtch.getVoltageSensorState(
                                                Name)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printDWDMModuleNwIntfPMState(self, Resource,NwIntfId,Type,Class,ModuleId, addHeader=True, brief=None):
        ...
        objs = self.swtch.getDWDMModuleNwIntfPMState(
                                                     Resource,
                                                     NwIntfId,
                                                     Type,
                                                     Class,
    ...
    def printArpEntryHwState(self, IpAddr, addHeader=True, brief=None):
        ...
        objs = self.swtch.getArpEntryHwState(
                                             IpAddr)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printOspfGlobalState(self, RouterId, addHeader=True, brief=None):
        ...
        objs = self.swtch.getOspfGlobalState(
                                             RouterId)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printRouteStatsPerProtocolState(self, Protocol, addHeader=True, brief=None):
        ...
        objs = self.swtch.getRouteStatsPerProtocolState(
                                                        Protocol)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
    ...
    def printBGPv6RouteState(self, CIDRLen,Network, addHeader=True, brief=None):
        ...
        objs = self.swtch.getBGPv6RouteState(
                                             CIDRLen,
                                             Network)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
    ...
    def printBGPv4RouteState(self, CIDRLen,Network, addHeader=True, brief=None):
        ...
        objs = self.swtch.getBGPv4RouteState(
                                             CIDRLen,
                                             Network)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
    ...
    def printVrrpVridState(self, VRID,IfIndex, addHeader=True, brief=None):
        ...
        objs = self.swtch.getVrrpVridState(
                                           VRID,
                                           IfIndex)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
    ...
    def printOspfIfEntryState(self, IfIpAddress,AddressLessIf, addHeader=True, brief=None):
        ...
        objs = self.swtch.getOspfIfEntryState(
                                              IfIpAddress,
                                              AddressLessIf)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
    ...
    def printRIBEventState(self, Index, addHeader=True, brief=None):
        ...
        objs = self.swtch.getRIBEventState(
                                           Index)
        if objs.status_code in self.httpSuccessCodes:
            for obj in objs:
                o = obj['Object']
